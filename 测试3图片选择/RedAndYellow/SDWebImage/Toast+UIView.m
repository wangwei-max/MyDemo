...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle =[message boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:titleDic context:nil].size;
    ...
    if (message != nil) {
        ...
        NSDictionary * MessageDic = [NSDictionary dictionaryWithObjectsAndKeys:messageLabel.font, NSFontAttributeName,nil];
        
        CGSize expectedSizeMessage =[message boundingRectWithSize:maxSizeMessage options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:MessageDic context:nil].size;
